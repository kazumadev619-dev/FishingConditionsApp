...
> {
  ...
  /**
   * `prisma.environmental_data`: Exposes CRUD operations for the **environmental_data** model.
   * Example usage:
   * ```ts
   * // Fetch zero or more Environmental_data
   * const environmental_data = await prisma.environmental_data.findMany()
   * ```
   */
  get environmental_data(): Prisma.environmental_dataDelegate<ExtArgs, { omit: OmitOpts }>;
  ...
  /**
   * `prisma.user_location_history`: Exposes CRUD operations for the **user_location_history** model.
   * Example usage:
   * ```ts
   * // Fetch zero or more User_location_histories
   * const user_location_histories = await prisma.user_location_history.findMany()
   * ```
   */
  get user_location_history(): Prisma.user_location_historyDelegate<ExtArgs, { omit: OmitOpts }>;
