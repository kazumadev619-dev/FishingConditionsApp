...
export type identitiesGetPayload<S extends boolean | null | undefined | identitiesDefaultArgs> =
...
> {
  ...
  >(
    args: Prisma.SubsetIntersection<T, identitiesGroupByArgs, OrderByArg> & InputErrors,
  ): {} extends InputErrors ? GetIdentitiesGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>;
  /**
