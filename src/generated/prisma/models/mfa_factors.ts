...
export type mfa_factorsGetPayload<S extends boolean | null | undefined | mfa_factorsDefaultArgs> =
...
> {
  ...
  >(
    args: Prisma.SubsetIntersection<T, mfa_factorsGroupByArgs, OrderByArg> & InputErrors,
  ): {} extends InputErrors ? GetMfa_factorsGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>;
  /**
