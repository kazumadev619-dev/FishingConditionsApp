...
export type sso_domainsGetPayload<S extends boolean | null | undefined | sso_domainsDefaultArgs> =
...
> {
  ...
  >(
    args: Prisma.SubsetIntersection<T, sso_domainsGroupByArgs, OrderByArg> & InputErrors,
  ): {} extends InputErrors ? GetSso_domainsGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>;
  /**
